<?php
namespace Limitlex\ForumPay\Controller;

use Magento\Framework\App\CsrfAwareActionInterface;
use Magento\Framework\App\Request\InvalidRequestException;
use Magento\Framework\App\RequestInterface;

abstract class AbstractController extends \Magento\Framework\App\Action\Action implements CsrfAwareActionInterface
{
    ...
    public function __construct(
        ...
        \Limitlex\ForumPay\Model\ForumPay $forumPayModel,
    ...
    {
        $additionalData = $this->getCheckoutSession()->getQuote()->getPayment()->getData('additional_data');
